...
function USApop(array){
  return array.reduce(function (acc, animal){
...
// console.log(consume("a", "b", (a,b)=> a + b));
...
// const lowerCaseNames = (array) => {
//   return array.map(animal => {
//     return animal.animal_name.toLowerCase();
//   });
// };

// const lowPopulationAnimals = (array) => {
...
// const myCuboid = new CuboidMaker({
//   length: 1,
//   width: 2,
//   height: 3
// });
...
// console.log(my2ndCuboid);
// console.log(my2ndCuboid.volume());
// console.log(my2ndCuboid.surfaceArea());
